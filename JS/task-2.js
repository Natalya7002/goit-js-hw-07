...
images.forEach(function (image) {
  ...
  // Уставлюємо атрибути src та alt для зображень(JPT в помощь)
  imageElement.src = image.url;
  imageElement.alt = image.alt;

  // Додаємо зображення до елемента li
  listGallery.appendChild(imageElement);

  // Додаємо новий елемент до списку
  galleryList.appendChild(listGallery);
});
